'''
Sample script for a Hello World extension which adds to Slicer a Hello World module, opening a
Hello World dialog when triggered.
...
To run this sample script manually, start Slicer with the following arguments.
